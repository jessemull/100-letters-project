# 100 Letters Project client — developer commands.
# Run `make` or `make help` for targets.

.DEFAULT_GOAL := help

.PHONY: help lint lint-fix format typecheck test test-coverage e2e lighthouse build preflight security dev

help: ## Help@show targets
	@printf '100 Letters Project — make <target>\n\n'
...
lint: ## Quality@ESLint / next lint with --fix
	npm run lint
