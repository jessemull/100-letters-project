...
/**
 * Locked viewport shell (dashboard pattern) — avoids sticky/fixed footer fights.
 *
 * Header never scrolls away. Sidebar fills the row under the header and scrolls
 * internally. Main scrolls on its own; footer lives at the end of that column
 * (beside the sidebar, never under it).
 */
